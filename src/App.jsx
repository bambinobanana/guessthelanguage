...
const LANG_FLAGS = {
  ...
  "Marathi":"🇮🇳","Gujarati":"🇮🇳","Punjabi":"🇮🇳","Odia":"🇮🇳",  "Hausa":"🇳🇬","Igbo":"🇳🇬","Somali":"🇸🇴","Oromo":"🇪🇹","Lingala":"🇨🇩",
  "Xhosa":"🇿🇦","Shona":"🇿🇼","Fula":"🌍",
...
const LANGUAGES = [
  ...
  { name:"Hausa", family:"Afro-Asiatic (Chadic)", region:"West Africa", script:"Latin", speakers:"~70M",
    tip:"Hausa uses clean Latin with no special characters. Look for the letters b with hook and d with hook for implosive consonants, and the apostrophe-k for ejective. Very frequent use of -na, -ta, -ya suffixes for gender agreement.",
    confusables:["Swahili","Yoruba","Igbo","Wolof","Somali"],
    quotes:[
      {s:"Haƙuri maganin zaman duniya.",t:"Patience is the medicine for the trials of the world."},
      {s:"Ilimi shine mafarin dukkan abubuwa.",t:"Knowledge is the beginning of all things."},
  ...
  { name:"Igbo", family:"Niger-Congo", region:"West Africa", script:"Latin", speakers:"~44M",
    tip:"Igbo uses Latin with many tone marks: dot below vowels like o-dot and u-dot, and the letter n-dot. The combinations nw and ny appear frequently. Vowel harmony makes Igbo text look very vowel-rich.",
    ...
    quotes:[
      ...
      {s:"Onye nwere mmadu adigh enwu ochu.",t:"One who has people does not die alone."},
    ]},
  { name:"Somali", family:"Afro-Asiatic (Cushitic)", region:"East Africa", script:"Latin", speakers:"~22M",
    tip:"Somali uses Latin with a very distinctive double vowel pattern like aa, ee, oo and the letter c for a pharyngeal sound. The apostrophe appears for glottal stop. Look for words ending in vowels and the frequent -ta, -ka suffixes.",
    confusables:["Swahili","Hausa","Oromo","Afar","Tigrinya"],
    quotes:[
      {s:"Nin baa lagu gartaa xikmaddiisa.",t:"A man is known by his wisdom."},
      {s:"Samir waa sadex geesood.",t:"Patience is a three-pointed thing — it always holds up."},
  ...
  { name:"Oromo", family:"Afro-Asiatic (Cushitic)", region:"East Africa", script:"Latin", speakers:"~40M",
    ...
    confusables:["Somali","Hausa","Swahili","Afar","Amharic"],
    quotes:[
      {s:"Beekumsi bilisummaa.",t:"Knowledge is freedom."},
      {s:"Obsi mi'aa firii guddaa qaba.",t:"Patience has the sweetness of great fruit."},
      {s:"Namni wajjin jiraate wajjin du'a.",t:"He who lives with others also dies with others — community is everything."},
    ]},
  { name:"Lingala", family:"Niger-Congo (Bantu)", region:"Central Africa", script:"Latin", speakers:"~45M",
    tip:"Lingala uses Latin with a distinctive open-o letter and open-e letter. Look for the prefix mo- for singular nouns and ba- for plural. The word na meaning and or with appears very frequently as a connector.",
    confusables:["Swahili","Kongo","Igbo","Yoruba","Zulu"],
    quotes:[
      {s:"Boyokani ezali nguya.",t:"Unity is strength."},
      {s:"Moto azali na ntina ya moto.",t:"A person is important because of other people."},
      {s:"Luka makambu ya malamu.",t:"Seek good things."},
    ]},
  { name:"Xhosa", family:"Niger-Congo (Bantu)", region:"Southern Africa", script:"Latin", speakers:"~19M",
    tip:"Xhosa uses Latin but has three types of click consonants: c for dental click, q for palatal click, x for lateral click. These can be combined with other consonants like gc, nc, xh. The clicks make it instantly recognizable.",
    confusables:["Zulu","Swahili","Sotho","Ndebele","Tsonga"],
    quotes:[
      {s:"Umntu ngumntu ngabantu.",t:"A person is a person through other people."},
      {s:"Inyaniso ayipheli.",t:"Truth never ends."},
      {s:"Ukuze ukhule, funda.",t:"In order to grow, learn."},
    ]},
  { name:"Shona", family:"Niger-Congo (Bantu)", region:"Southern Africa", script:"Latin", speakers:"~15M",
    tip:"Shona uses Latin without special characters. Look for the distinctive consonant clusters sv, zv, dz and the prefix mu- for people and chi- for languages or things. Words are typically CV (consonant-vowel) structured.",
    confusables:["Zulu","Swahili","Xhosa","Ndebele","Sotho"],
    quotes:[
      {s:"Chipo chakanaka kuripa zvakanaka.",t:"A good gift deserves good repayment."},
      {s:"Ruka usiku, zorora masikati.",t:"Work at night, rest in the afternoon — perseverance pays."},
  ...
  { name:"Fula", family:"Niger-Congo", region:"West Africa", script:"Latin", speakers:"~40M",
    tip:"Fula uses Latin with the special letter ng-hook at word starts and frequent long vowels marked double. The language has an unusual noun class system where the same word changes consonant depending on its class. Look for -nde, -ngal, -wal endings.",
    confusables:["Wolof","Hausa","Igbo","Bambara","Mandinka"],
    quotes:[
      {s:"Munyal yowitii ko nano.",t:"Patience sweetens what is bitter."},
      {s:"Ganndal woni dimo.",t:"Knowledge makes one free."},
      {s:"Jom galle jom yiyde.",t:"The master of the household is the master of hearts."},
    ]},

  // ── NEW ASIAN ──
  { name:"Sundanese", family:"Austronesian", region:"Southeast Asia", script:"Latin", speakers:"~42M",
    tip:"Sundanese uses Latin in modern writing and looks similar to Indonesian and Malay. Look for the words abdi meaning I or servant and ka meaning to. The combination eu as a vowel and the -eun suffix are distinctively Sundanese.",
    ...
    quotes:[
      ...
      {s:"Ulah poho kana jasa nu geus ngabantu urang.",t:"Do not forget the kindness of those who have helped you."},
    ]},
  { name:"Cebuano", family:"Austronesian", region:"Southeast Asia", script:"Latin", speakers:"~27M",
    tip:"Cebuano uses Latin without special characters. Look for the very frequent word nga as a linker between words, the prefix mag- for verbs, and -on, -an, -i suffixes. Similar to Tagalog but uses lahi for different and dili for no instead.",
    confusables:["Tagalog","Indonesian","Malay","Ilocano","Hiligaynon"],
    quotes:[
      {s:"Ang kinabuhi mapuslanon kon gamiton sa pagtabang sa uban.",t:"Life is useful when used to help others."},
  ...
  { name:"Turkmen", family:"Turkic", region:"Central Asia", script:"Latin", speakers:"~11M",
    tip:"Turkmen uses Latin since 1993 with letters like y with circumflex, n with hook, o-umlaut, u-umlaut, zh, and a distinctive c for the ch sound. Very similar to other Turkic Latin scripts but the y-circumflex is a giveaway.",
    confusables:["Uzbek","Azerbaijani","Turkish","Kazakh","Kyrgyz"],
    quotes:[
      {s:"Bilim - baýlyk.",t:"Knowledge is wealth."},
      {s:"Sabyrly bol, süýji iý.",t:"Be patient, eat sweetness — patience brings rewards."},
      {s:"Agzybirlik - gudrat.",t:"Unity is a miracle."},
    ]},
  { name:"Sindhi", family:"Indo-Iranian", region:"South Asia", script:"Perso-Arabic", speakers:"~30M",
    tip:"Sindhi uses a modified Perso-Arabic script with more dots and special characters than standard Arabic or Urdu. It has 52 letters compared to Arabic's 28. The extra dotted letters like those with four dots are uniquely Sindhi.",
    confusables:["Urdu","Arabic","Persian (Farsi)","Pashto","Balochi"],
    quotes:[
      {s:"علم اهو آهي جيڪو ڪم اچي.",t:"Knowledge is what is useful."},
      {s:"صبر جو ميوو مٺو هوندو آهي.",t:"The fruit of patience is sweet."},
    ]},
  { name:"Assamese", family:"Indo-Iranian", region:"South Asia", script:"Bengali", speakers:"~15M",
    tip:"Assamese uses a script nearly identical to Bengali with tiny differences in a few characters. The letter w-like character and a slightly different r distinguish it from Bengali. The language has a breathy quality with aspirated consonants.",
    confusables:["Bengali","Odia","Maithili","Sylheti","Manipuri"],
    quotes:[
      {s:"জ্ঞানেই শক্তি।",t:"Knowledge is power."},
      {s:"ধৈৰ্যই সকলো সমস্যাৰ সমাধান।",t:"Patience is the solution to all problems."},
    ]},
  { name:"Maithili", family:"Indo-Iranian", region:"South Asia", script:"Devanagari", speakers:"~34M",
    tip:"Maithili uses Devanagari like Hindi and Nepali but with a distinctive script style historically. Modern Maithili looks very close to Hindi. Look for the words छी and अछि as verbs meaning is — they are distinctively Maithili.",
    confusables:["Hindi","Nepali","Bengali","Bhojpuri","Magahi"],
    quotes:[
      {s:"जे सहए से रहए।",t:"He who endures, remains."},
      {s:"विद्या सबसँ पैघ धन छी।",t:"Knowledge is the greatest wealth."},
    ]},
  { name:"Balochi", family:"Indo-Iranian", region:"South Asia / Middle East", script:"Perso-Arabic", speakers:"~9M",
    tip:"Balochi uses Perso-Arabic script similar to Urdu and Persian. It has fewer speakers than Urdu so is rarer to encounter. The words show heavy Iranian influence. Look for the -ag and -it verb endings which distinguish it from Urdu.",
    confusables:["Urdu","Pashto","Persian (Farsi)","Sindhi","Brahui"],
    quotes:[
      {s:"ئیلم گنج انت.",t:"Knowledge is a treasure."},
      {s:"صبر کن و شیرین بخور.",t:"Be patient and eat sweetness."},
    ]},
  { name:"Santali", family:"Austroasiatic", region:"South Asia", script:"Ol Chiki", speakers:"~7.6M",
    ...
    quotes:[
      {s:"ᱢᱤᱛᱟᱹᱱ ᱦᱚᱲ ᱟᱠᱟᱱᱟ ᱢᱤᱛᱟᱹᱱᱠᱷᱟᱱ ᱵᱟᱹᱦᱲᱮᱱᱟ।",t:"A united people is stronger than anything."},
      {s:"ᱯᱟᱲᱦᱟᱣ ᱟᱠᱟᱱᱟ ᱟᱞᱚ ᱮᱢ ᱟᱠᱟᱱᱟ।",t:"Learning is light, ignorance is darkness."},
    ]},
  { name:"Shan", family:"Tai-Kadai", region:"Southeast Asia", script:"Shan", speakers:"~6M",
    ...
    confusables:["Myanmar (Burmese)","Thai","Lao","Khmer","Mon"],
    quotes:[
      {s:"ၸႂ်လီႈပေႃးမၢၼ်ႇ တွင်ႉပၢင်ႇၸဝ်ႈ။",t:"A patient heart finds the way forward."},
    ]},
  { name:"Buryat", family:"Mongolic", region:"East Asia / Siberia", script:"Cyrillic", speakers:"~265K",
    tip:"Buryat uses Cyrillic with extra letters including the open-o and open-u vowels unique to Mongolian languages. It looks very similar to Mongolian Cyrillic. The vocabulary is Mongolian in origin making it differ sharply from Russian.",
    confusables:["Mongolian","Russian","Kazakh","Kyrgyz","Kalmyk"],
    quotes:[
      {s:"Эрдэм — далай, тэнгэри — хязаар.",t:"Knowledge is the ocean, the sky is the limit."},
      {s:"Тэсэбэри хүн амжалтада хүрэдэг.",t:"A patient person achieves success."},
    ]},
  { name:"Tok Pisin", family:"English Creole", region:"Pacific (Papua New Guinea)", script:"Latin", speakers:"~5M",
    tip:"Tok Pisin looks like broken English but is a fully distinct creole language. Words like gras meaning grass or hair, save meaning to know, and bagarap meaning broken reveal its English roots twisted into new meanings. Very confusing for English speakers.",
    confusables:["Indonesian","Malay","Tetum","Bislama","Pijin"],
    quotes:[
      {s:"Gutpela sindaun i kamap long gutpela wok.",t:"Good living comes from good work."},
      {s:"Save em i gutpela samting tru.",t:"Knowledge is truly a good thing."},
      {s:"Yumi wankain olsem.",t:"We are all the same."},
    ]},

  // ── NEW EUROPEAN / CAUCASUS ──
  { name:"Sardinian", family:"Romance", region:"Europe", script:"Latin", speakers:"~1M",
    tip:"Sardinian is considered the closest living language to Latin. Look for Latin-like words: domo for house, domine for lord. The -u ending on masculine words instead of Italian's -o is a giveaway. Also look for k and z sounds written as ch and tz.",
    confusables:["Italian","Corsican","Catalan","Spanish","Sicilian"],
    quotes:[
  ...
  { name:"Corsican", family:"Romance", region:"Europe", script:"Latin", speakers:"~150K",
    tip:"Corsican looks like a mix of Italian and Sardinian. Look for double consonants like tt, nn, mm and words ending in -u instead of Italian -o. The -ghju and -cciu endings are distinctively Corsican.",
    confusables:["Italian","Sardinian","Catalan","Sicilian","Spanish"],
    quotes:[
      {s:"A lingua hè l'anima di un populu.",t:"Language is the soul of a people."},
      {s:"Chì cerca trova.",t:"He who seeks, finds."},
    ]},
  { name:"Romani", family:"Indo-Iranian", region:"Europe (diaspora)", script:"Latin", speakers:"~3.5M",
    tip:"Romani uses Latin but with Indo-Iranian roots making it look surprisingly different from European languages. Look for words like baro meaning big, miro meaning my, and the -as, -as verb endings. Has many loanwords from Greek, Romanian, and Slavic languages.",
    confusables:["Romanian","Hindi","Rajasthani","Hindi","Sanskrit"],
    quotes:[
      {s:"O kham avel avri sar o rat.",t:"The sun comes out like blood — beauty after hardship."},
      {s:"Čačipen si baro zor.",t:"Truth is great strength."},
    ]},
  { name:"Chechen", family:"Northeast Caucasian", region:"Caucasus", script:"Cyrillic", speakers:"~1.5M",
    tip:"Chechen uses Cyrillic with extra letters for ejective consonants and pharyngeal sounds not in Russian. Look for the letters with descenders and the frequent apostrophe for ejective sounds. Very different vocabulary from Russian despite using the same script.",
    confusables:["Russian","Ingush","Avar","Georgian","Armenian"],
    quotes:[
      {s:"Нохчийн мотт — нохчийн оьзда.",t:"The Chechen language is the Chechen dignity."},
      {s:"Сабар бар — хьекъалан бух бу.",t:"Patience is the foundation of wisdom."},
    ]},
  { name:"Abkhazian", family:"Northwest Caucasian", region:"Caucasus", script:"Cyrillic", speakers:"~190K",
    tip:"Abkhazian uses Cyrillic with many extra letters for its complex consonant inventory — one of the largest in the world. Look for letters with multiple diacritics stacked on them. The language has very few vowels but many consonant clusters.",
    confusables:["Georgian","Chechen","Russian","Kabardian","Circassian"],
    quotes:[
      {s:"Ашьхәара далырхәо иааирхо.",t:"He who seeks wisdom finds it."},
      {s:"Аиҿцәажәара далырхәо иааирхо.",t:"A good word opens all doors."},
    ]},

  // ── NEW AMERICAS / PACIFIC ──
  { name:"Aymara", family:"Aymaran", region:"South America (Andes)", script:"Latin", speakers:"~2M",
    tip:"Aymara uses Latin with apostrophes for ejective consonants like p-apostrophe, t-apostrophe, k-apostrophe similar to Quechua. Look for the suffix -wa at sentence ends for assertion and -ti for questions. Frequent use of jani meaning no.",
    confusables:["Quechua","Nahuatl","Guaraní","Mapuche","Zapotec"],
    quotes:[
      {s:"Yatiña uñjawi ukhamaraki.",t:"To know is to see."},
      {s:"Janiw wali sarakipans ukar jutxiti.",t:"Good things do not come without effort."},
    ]},
  { name:"Mapuche", family:"Araucanian", region:"South America (Chile/Argentina)", script:"Latin", speakers:"~260K",
    tip:"Mapuche (Mapudungun) uses Latin with the distinctive letter tr for a retroflex sound and the letter f-with-stroke for a bilabial fricative. Look for the suffixes -nge, -le, -fu and the word feley meaning it is so.",
    confusables:["Quechua","Aymara","Guaraní","Nahuatl","Rapa Nui"],
    quotes:[
      {s:"Kimeltuwe che pu mogen mew.",t:"Knowledge gives life to the people."},
      {s:"Mapuche zugun reke newen.",t:"The Mapuche language is like strength."},
    ]},
  { name:"Ojibwe", family:"Algonquian", region:"North America", script:"Latin", speakers:"~170K",
    tip:"Ojibwe uses Latin with long vowels marked by macrons or double letters: aa, ii, oo. The letters zh, sh, ch and the combination gw appear frequently. Words are very long due to polysynthetic structure where a whole sentence can be one word.",
    confusables:["Cree","Navajo","Hmong","Inuktitut","Cherokee"],
    quotes:[
      {s:"Mii dash ezhi-bimaadiziyaang.",t:"And so we live this way."},
      {s:"Gikenimaaganag wii-maajaawag.",t:"The ones we know are leaving — cherish connections."},
    ]},
  { name:"Cherokee", family:"Iroquoian", region:"North America", script:"Cherokee syllabary", speakers:"~2K",
    tip:"Cherokee uses its own syllabary invented by Sequoyah in 1821. Each character represents a syllable. The characters look somewhat like Latin letters but represent completely different sounds. A D looks like Cherokee but sounds like go, not the English letter.",
    confusables:["Inuktitut","Santali","Tibetan","Ol Chiki","Cree"],
    quotes:[
      {s:"ᏂᎦᏓ ᏧᏂᎸᏫᏍᏓᏁᏗ ᏂᎨᏒᎾ.",t:"We will always remember where we came from."},
      {s:"ᎠᏂᏴᏫ ᏧᏂᎸᏉᏗ ᎠᏍᏓᏅᏅ.",t:"People must help one another."},
    ]},
  { name:"Inuktitut", family:"Eskimo-Aleut", region:"Arctic (Canada / Greenland)", script:"Syllabics / Latin", speakers:"~40K",
    tip:"Inuktitut in Canada uses Canadian Aboriginal Syllabics — geometric shapes that look like triangles, wedges and small circles in different orientations. Each orientation represents a different vowel with the same consonant. Completely unlike any other writing system.",
    confusables:["Cherokee","Cree","Ojibwe","Santali","Tibetan"],
    quotes:[
      {s:"ᐃᓕᓐᓂᐊᕐᓂᖅ ᐱᑕᖃᕆᐊᖃᖅᑐᖅ.",t:"Learning is necessary for life."},
      {s:"ᐊᑦᑕᓇᖅᑐᒥᒃ ᐊᑎᓕᐅᕆᓂᖅ ᐱᒻᒪᕆᐊᓘᔪᖅ.",t:"Naming what is frightening gives us power over it."},
    ]},
  ...
  { name:"Quechua", family:"Quechuan", region:"South America (Andes)", script:"Latin", speakers:"~10M",
    ...
    confusables:["Guaraní","Nahuatl","Aymara","Maya (Yucatec)"],
    quotes:[
  ...
  { name:"Guaraní", family:"Tupian", region:"South America", script:"Latin", speakers:"~7M",
    ...
    confusables:["Quechua","Guaraní","Maya (Yucatec)","Hmong"],
    quotes:[
...
// Easy: 100M+ speakers | Medium: 10M–100M | Hard: under 10M
const EASY_LANGS = [
  ...
  "Hausa","Thai","Gujarati","Kannada","Tagalog","Sundanese","Malay",
  "Yoruba","Pashto","Igbo","Oromo","Lingala","Fula","Urdu","French","Polish",
];
...
const HARD_LANGS = [
  ...
  "Quechua","Nahuatl","Guaraní","Maya (Yucatec)","Navajo","Hawaiian","Māori","Tibetan",
];

// Medium = 10M–100M speakers — everything not in Easy or Hard:
// Dutch, Greek, Swedish, Norwegian, Icelandic, Afrikaans, Luxembourgish,
// Romanian, Catalan, Galician, Occitan removed (Hard), Ukrainian, Belarusian,
// Macedonian, Slovenian, Croatian, Slovak, Czech, Lithuanian, Latvian,
// Finnish, Hungarian, Estonian, Albanian, Maltese, Georgian, Armenian, Hebrew,
// Mongolian, Lao, Khmer, Myanmar (Burmese), Azerbaijani, Uzbek, Kazakh,
// Kyrgyz, Tajik, Uyghur, Nepali, Odia, Assamese, Maithili, Sindhi,
// Sinhala, Zulu, Bulgarian, Serbian, Somali, Amharic, Cebuano,
// Turkmen, Tok Pisin
...
export default function App() {
  ...
  useEffect(()=>{
    async function load() {
      try {
        const r=await window.storage.get("lg_global_leaderboard");
        if(r) setLeaderboard(JSON.parse(r.value));
      } catch(e) {
...
function Home({onStart,leaderboard}) {
  ...
  const levels=[
    {id:"easy", label:"🟢 Easy", speakers:"100M+ speakers", desc:"The world's most widely spoken languages — you've probably heard these before."},
    {id:"medium", label:"🟡 Medium", speakers:"10M–100M speakers", desc:"Regional and national languages spoken by tens of millions — less familiar but still major."},
    {id:"hard", label:"🔴 Hard", speakers:"Under 10M speakers", desc:"Minority, indigenous and rare languages — a real challenge for any language lover."},
    {id:"mix", label:"🌍 Mix", speakers:"All 100 languages", desc:"Every language in the game — from Mandarin to Cherokee. Pure chaos, maximum learning."},
  ];
  return (
    <div style={{maxWidth:420,margin:"0 auto",padding:"2rem 1rem",textAlign:"center",fontFamily:"sans-serif"}}>
          ...
          {levels.map(l=>(
            <button key={l.id} onClick={()=>setLevel(l.id)}
              ...
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:2}}>
                ...
                <span style={{fontSize:10,color:C.light,fontWeight:400}}>{l.speakers}</span>
              </div>
      ...
      {leaderboard.length>0&&(
        <div style={{background:C.fog,borderRadius:12,padding:"0.85rem 1rem",textAlign:"left"}}>
          ...
          {leaderboard.filter(e=>lbFilter==="all"||(e.level||"medium")===lbFilter).slice(0,5).map((e,i)=>{
          ...
          {leaderboard.filter(e=>lbFilter==="all"||(e.level||"medium")===lbFilter).length===0&&(
            <p style={{fontSize:12,color:C.light,margin:0,textAlign:"center",padding:"0.5rem 0"}}>No scores yet for this level</p>
          )}
        </div>
      )}
...
function Done({results,total,max,onRestart,leaderboard,setLeaderboard,level}) {
  ...
  async function submitScore() {
    ...
    const entry={name:nickname.trim(),score:total,level,date:new Date().toLocaleDateString("en-GB",{day:"numeric",month:"short",year:"2-digit"})};
    const board=[...leaderboard,entry].sort((a,b)=>b.score-a.score).slice(0,5);
    setLeaderboard(board);
    setSubmitted(true);
    try{await window.storage.set("lg_global_leaderboard",JSON.stringify(board),true);}catch(e){
            ...
            {leaderboard.slice(0,5).map((e,i)=>{
              ...
              return (
                <div key={i} style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"6px 0",borderBottom:i<Math.min(leaderboard.length,5)-1?`1px solid ${C.fog}80`:"none"}}>
                  ...
                  <span style={{fontSize:13,fontWeight:500,color:C.ocean}}>{e.score}<span style={{fontSize:10,color:C.light}}>/{max}</span></span>
                </div>
              );
            })}
          </>
